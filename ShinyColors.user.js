	...
	*/
	...
	const getStory = async name => {
	  if (!storyIndex) {
	    ...
	    if (!storyIndexStr) {
	      const storyIndexData = await fetchWithHash('/story-map.json');
